# -*- coding: utf-8 -*-
#
# ncpol2sdpa documentation build configuration file, created by
...
htmlhelp_basename = 'ncpol2sdpadoc'
...
man_pages = [
    ('index', 'ncpol2sdpa', u'ncpol2sdpa Documentation',
     [u'Peter Wittek'], 1)
]
...
texinfo_documents = [
  ('index', 'ncpol2sdpa', u'ncpol2sdpa Documentation',
   u'Peter Wittek', 'ncpol2sdpa', 'One line description of project.',
   'Miscellaneous'),
]
